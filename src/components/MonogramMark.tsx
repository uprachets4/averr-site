  ...
  return (
    <div style={{ display: "block", width: "100%" }}>
      ...
      >
        ...
        />
        {/* Fill layer — fades in after the stroke completes, with a small
            100ms overlap so the mark never appears empty. */}
        <motion.path
          d={MARK_PATH_D}
          fill="currentColor"
          fillRule="evenodd"
...
export default function MonogramMark({ variant = "hero", className }: Props) {
  ...
  const useStrokeDraw = variant === "hero" || variant === "signature";
